...
class Selector {
 ...
 private:
  ...
  const ROOT::Detail::RDF::ColumnNames_t cols_ = {"event", "run", "NRechits", "rechit_detid", "rechit_x", "rechit_y", "rechit_z", "rechit_layer", "rechit_iu", "rechit_iv", "rechit_iU", "rechit_iV", "rechit_type", "rechit_energy", "beamEnergy", "trueBeamEnergy", "pdgID"};
  struct indata {
