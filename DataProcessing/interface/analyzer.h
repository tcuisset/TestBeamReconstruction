...
class Analyzer {
 ...
 private:
  ...
  std::vector< std::vector< std::array< std::tuple<float, float, std::vector<float>, std::vector<float>>, detectorConstants::nlayers> > > fracs_; //fraction of clusterized nhits and clusterized energy per event
