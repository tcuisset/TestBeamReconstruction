...
int main(int argc, char **argv) {
  ...
  *////////////////////////
  ...
  std::ifstream infile(cmssw_base + "/src/TestBeamReconstruction/CondorJobs/ntuple_ids.txt");
  std::vector<int> a;
  int _a;
  while (infile >> _a)
      a.push_back(_a);
  ...
  std::ofstream f_write(cmssw_base + "/src/TestBeamReconstruction/CondorJobs/file_names.txt");
